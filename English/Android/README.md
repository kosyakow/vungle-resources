...
## Changelog
### VERSION 3.3.3
* Added support for Android Marshmallow by simplifying the required app permissions. From Android Kitkat and above, the SDK doesn't need `android.permission.WRITE_EXTERNAL_STORAGE`
